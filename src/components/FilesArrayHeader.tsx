...
const FilesArrayHeader = <T,>({ onSortChange, sortDirection, columns, columnSorted }: Props<T>) => {
	...
	return (
		<header className="grid grid-cols-5-1-1-1 pb-4 w-full">
			<div className="flex-1 truncate col-span-1 flex gap-4 pl-24">
				{columns[0].label}
